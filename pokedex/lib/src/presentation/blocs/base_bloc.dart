...
abstract class BaseBloc<E extends Events> {
  /// Subs
  ...
  Function(E) get event => _eventController.sink.add;
  Stream<E> get _event => _eventController.stream;
  ...
  void dispose() {
    ...
    _eventController.drain<dynamic>();
